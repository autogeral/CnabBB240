...
public class LineCnab240BBSegmentoP extends LineArchetype {
    ...
    /**
     * DIGITO_VERIFICADOR_AGENCIA_ENCARREGADA
     * POSICAO 106 106
     * 1 POSICAO
     */
    ...
    public LineCnab240BBSegmentoP() {
        ...
        addFieldArchetype(CODIGO_BANCO_COMPENSACAO, new FieldIntegerFixedLengthArchetype(3));//4
        addFieldArchetype(CODIGO_DO_LOTE, new FieldIntegerFixedLengthArchetype(4));//7
        addFieldArchetype(TIPO_DE_REGISTRO, new FieldDefaultArchetype("3"));//8
        ...
        addFieldArchetype(NUMERO_CONTA, new FieldIntegerFixedLengthArchetype(12));//35
        ...
        addFieldArchetype(IDENTIFICACAO_TITULO_BANCO, new FieldStringFixedLengthArchetype(20));//Nosso numero 57
        ...
        addFieldArchetype(CODIGO_JUROS, new FieldIntegerFixedLengthArchetype(1));//118
        addFieldArchetype(DATA_JUROS, new FieldDateFixedLengthArchetype("ddMMyyyy"));//126
        addFieldArchetype(JUROS_MORA_DIA_TAXA, new FieldDecimalFixedLengthArchetype(15, 2));//141
        addFieldArchetype(CODIGO_DESCONTO_1, new FieldIntegerFixedLengthArchetype(1));//142
        addFieldArchetype(DATA_DESCONTO_1, new FieldDateFixedLengthArchetype("ddMMyyyy"));//150
        ...
        addFieldArchetype(DIAS_PARA_PROTESTO, new FieldIntegerFixedLengthArchetype(2));//223
        addFieldArchetype(CODIGO_BAIXA_DEVOLUCAO, new FieldIntegerFixedLengthArchetype(1));//224
        addFieldArchetype(PRAZO_BAIXA_DEVOLUCAO, new FieldIntegerFixedLengthArchetype(3));//227
        addFieldArchetype(MOEDA, new FieldIntegerFixedLengthArchetype(2));//229
        addFieldArchetype(NUMERO_CONTRATO_OPERACAO_CREDITO, new FieldIntegerFixedLengthArchetype(10));//239
        addFieldArchetype(BRANCOS_1, new FieldDefaultArchetype(" "));//240
