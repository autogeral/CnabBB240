...
public class LineCnab240BBHeaderLote extends LineArchetype{
    ...
    /**
     * VARIACAO DA CARTEIRA DE COBRANCA
     * POSICAO 049 051
     * PICTURE 9(3)
     * CONTEUDO NOTA 2
     */
    ...
    /**
     * CAMPO PARA REMESSA DE TESTE
     * CASO NAO FOR TESTE PREENCHER COM BRANCOS
     * AO CONTRARIO PREENCHER COM TS
     * POSICAO 052 053
     * PICTURE 9(2)
     * CONTEUDO NOTA 2
     */
    ...
    /**
     * N.� SEQ. ARQUIVO RET.
     * NUMERO SEQUENCIAL DO ARQUIVO DE RETORNO
     * POSICAO 184 191
     * PICTURE 9(08)
     */
...
//*****************************Registro Header de Lote****************************************
        ...
        addFieldArchetype(DATA_GRAVACAO_ARQUIVO, new FieldIntegerFixedLengthArchetype(8));
